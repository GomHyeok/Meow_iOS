...
/// Since DataSource is a staticFramework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "Data_DataSource"
    var candidates = [
    ...
    fatalError("unable to find bundle named Data_DataSource")
}()
