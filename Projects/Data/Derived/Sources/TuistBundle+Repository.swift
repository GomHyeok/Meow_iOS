...
/// Since Repository is a staticFramework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "Data_Repository"
    var candidates = [
    ...
    fatalError("unable to find bundle named Data_Repository")
}()
}// MARK: - Objective-C Bundle Accessor
@objc
public class RepositoryResources: NSObject {
